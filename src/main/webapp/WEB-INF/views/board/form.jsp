...
<body>
	...
	<main>
		...
		<section class="py-1 text-center container">
			<form class="album py-1 bg-light" action="/ddit/board/insert.do" method="post" id="dditboard">
				<div class="">
					<div class="container">
						<div class="card-body">
						...
						<div class="card-footer" align="right">
							<button type="button" class="btn btn-primary" id="registerBtn" onclick="f_insert()">등록</button>
